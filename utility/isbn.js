...
(function() {
  ISBN = {
    ...
    hyphenate: function(val) {
      ...
      return me ?
        me.isIsbn13() ? me.asIsbn13(true) : me.asIsbn10(true) :
        null;
    },
  ...
  ISBN.isbn.prototype = {
    ...
    parse: function(val) {
      ...
      ret = val.match(/^\d{9}[\dX]$/) ?
        this.fill(
          this.merge({ source: val, isValid: true, isIsbn10: true, isIsbn13: false },
            this.split(val)
          )
        ) :
    ...
    split: function(isbn) {
      return !isbn ?
        ...
        isbn.length === 10 ? this.splitToObject(isbn) : null;
    },
