  ...
  describe('Eslite', function() {
    describe('getByISBN()', function() {
      it('should get the correct data of the book "以小勝大"', function(done) {
        Q.all(eslite.getByISBN('9789571358512')).then(function(value) {
          if (showData) {
            console.log(value);
          }
          ...
          if (
            value.ImageUrl !==
            'http://pic.eslite.com/Upload/Product/201312/m/635228661509612548.jpg'
          ) {
          ...
          if (value.Author !== '麥爾坎．葛拉威爾') {
            return done(
              'Author does not match - 麥爾坎．葛拉威爾 != ' + value.Author[0]
            );
          }
          done();
        });
